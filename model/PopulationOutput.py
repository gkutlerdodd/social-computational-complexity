...
class PopulationOutput(OutputWriter):
    ...
    def update(self, time):
        for n, d in list(self.metapopulation.topology.nodes(data=True)):
            ...
            if size == 0:
                ...
                genomes_present = d['population'].get_genomes_present()
            ...
            record = {'Time': time,
                      ...
                      'GenomesPresent':genomes_present,
                     }
